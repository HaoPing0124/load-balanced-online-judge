...
int main()
{
    CheckCase(1, Solution().findAnagrams("cbaebabacd", "abc"), vector<int>({0, 6}));
    CheckCase(2, Solution().findAnagrams("abab", "ab"), vector<int>({0, 1, 2}));
    CheckCase(3, Solution().findAnagrams("a", "aa"), vector<int>());
    return 0;
}
